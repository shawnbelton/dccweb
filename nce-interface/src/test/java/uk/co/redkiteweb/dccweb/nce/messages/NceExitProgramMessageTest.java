...
public class NceExitProgramMessageTest {

    private NceExitProgramMessage nceExitProgramMessage;
    private TalkToNCE talkToNCE;

    @Before
    public void setUp() {
        talkToNCE = mock(TalkToNCE.class);
        nceExitProgramMessage = new NceExitProgramMessage();
        nceExitProgramMessage.setTalkToNCE(talkToNCE);
    }
    ...
    private MessageResponse.MessageStatus testEnter(final Integer value) throws ConnectionException {
        ...
        return nceExitProgramMessage.process(new ExitProgramMessage()).getStatus();
    }
